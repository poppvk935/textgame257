...
public class Door extends Item {
	...
	public void use() {
		if(Game.getCurrentRoom().getName().equals("hall5") ){ //|| Game.getCurrentRoom().getName().equals("cell3")) {
			Game.print2("You shake the rusty old door and it break off its hinges, falling to the ground with an echoing thud.");
			...
			Game.print2("You shake the door but it doesn't budge. Not getting out that easy...");		}
	}
}
